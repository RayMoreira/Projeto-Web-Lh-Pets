...
namespace Projeto_Web_Lh_Pets_versão_1
{
    ...
    { 
        ...
        // Método para gerar a lista de clientes em formato HTML
        public string GetListaString()
        {
            ...
            foreach (Clientes cli in GetLista()) // Chama GetLista corretamente
            {
                if (i % 2 == 0)
                {   
                    corfundo = "#6f47ff"; 
        ...
        // Método para imprimir a lista de clientes no console
